package net.labormc.cloudapi.network.protocol.packets.channel;
...
@AllArgsConstructor
@Getter
public class PacketPlayInClientConnect implements IPacket {
    ...
    public void read(ByteBufInputStream input) throws IOException {
        try {
            ...
            Logger.getLogger(PacketPlayInClientConnect.class.getName()).log(Level.SEVERE, null, ex);
        }
